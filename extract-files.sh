...
function blob_fixup() {
    case "${1}" in
        ...
        vendor/bin/hw/android.hardware.security.keymint-service-qti | vendor/lib64/libqtikeymint.so)
            ...
            ;;
        vendor/bin/hw/dolbycodec2 | vendor/bin/hw/vendor.dolby.hardware.dms@2.0-service | vendor/bin/hw/vendor.dolby.media.c2@1.0-service | vendor/lib/hw/audio.primary.kalama.so | vendor/lib64/hw/audio.primary.kalama.so)
